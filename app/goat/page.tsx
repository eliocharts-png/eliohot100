            ...
            <div className="border-x border-b border-black/10 bg-white px-4 py-6 sm:px-6">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="mt-3 text-sm font-brown-regular leading-relaxed text-black/70 sm:text-base">
                  <em>
                    Songs are ranked based on an inverse point system, with weeks at №1 earning the greatest value and weeks at lower spots earning the least. Due to changes in chart methodology over the years, eras are weighted differently to account for chart turnover rates during periods. As of June 11th, 2026 week-ending.
                  </em>
                </p>
