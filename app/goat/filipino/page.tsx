...
export default function FilipinoGoatPage() {
  ...
  /*
   * Load the Filipino GOAT list once
  ...
  useEffect(() => {
    ...
    async function loadGoat() {
      ...
      try {
        ...
        console.error(
          'Failed to load Filipino GOAT chart:',
          error
        );
  ...
  async function toggleHistory(
    ...
    try {
      ...
      console.error(
        'Failed to load Filipino GOAT chart history:',
        error
      );
          ...
          <div className="border border-black/10 bg-white shadow-[0_30px_80px_rgba(0,0,0,0.08)]">
            ...
            {!loaded && (
              <div className="flex min-h-[300px] items-center justify-center">
                <p className="text-xs font-brown-regular uppercase tracking-[0.2em] text-black/50">
                  LOADING GREATEST OF ALL-TIME: FILIPINO SONGS
                </p>
              </div>
            )}
            ...
            {loaded &&
              entries.length === 0 && (
                <div className="flex min-h-[300px] items-center justify-center">
                  <p className="text-xs font-brown-regular uppercase tracking-[0.2em] text-black/50">
                    NO GREATEST OF ALL-TIME: FILIPINO SONGS DATA AVAILABLE
                  </p>
                </div>
              )}
