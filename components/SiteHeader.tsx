      ...
      <div className="mx-auto flex min-h-[3.8rem] max-w-7xl items-center px-4 sm:px-6 lg:px-8">
        ...
        <div className="ml-auto hidden items-center gap-5 lg:flex">
          ...
          <div className="group relative">
            ...
            <div className="invisible absolute left-1/2 top-full z-[120] w-56 -translate-x-1/2 pt-2 opacity-0 transition-all duration-150 group-hover:visible group-hover:opacity-100">
              ...
              <div className="border border-white/10 bg-black shadow-xl">
                ...
                <a
                  href="/goat/female"
                  className="block px-4 py-2.5 font-brown-regular text-xs text-white transition-colors duration-150 hover:bg-[#0050FF] hover:text-white"
                >
                  Female Songs
                </a>
              ...
              <div className="border-b border-white/10">
                ...
                <div className="pb-3 pl-4">
                  ...
                  <a
                    href="/goat/female"
                    onClick={closeMobileMenu}
                    className="block pt-2 font-brown-regular text-xs text-white transition-colors duration-150 hover:text-[#0050FF] active:text-[#0050FF]"
                  >
                    Female Songs
                  </a>
